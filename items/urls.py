...
urlpatterns = [
    ...
    path("my_cart", view=views.current_user_shopping_cart_details, name="current_user_cart"),
    ...
    path("delete_from_cart/<pk>", view=views.delete_from_shopping_cart, name="delete_from_cart"),
    path("update_cart_item/<pk>", view=views.update_cart_item_quantity, name="update_cart_item"),
]
